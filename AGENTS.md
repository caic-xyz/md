...
- `client_test.go`: Tests for the md client package.
- `cmd/md/main.go`: md (my devenv) manages isolated Docker development containers for AI coding
...
- `docker.go`: Docker operations and image building.
- `docker_test.go`: Tests for Docker operations.
- `docs/NETWORKING.md`: Container Outbound Network Restrictions
- `gitutil/commitmsg.go`: Commit message generation and formatting.
- `gitutil/commitmsg_test.go`: Tests for commit message generation.
- `gitutil/git.go`: Package gitutil provides git utility functions for repository introspection,
- `gitutil/git_test.go`: Tests for git repository utilities.
- `kvm_linux.go`: KVM availability detection for Linux.
- `kvm_other.go`: KVM stub for non-Linux platforms.
- `rootless_linux.go`: Rootless podman detection for Linux.
- `rootless_other.go`: Rootless podman stub for non-Linux platforms.
...
- `rsc/user/home/user/.config/bash.d/10-git.sh`: Git completion and prompt helpers.
- `rsc/user/home/user/.config/bash.d/20-rust-path.sh`: Rust toolchain paths.
- `rsc/user/home/user/.config/bash.d/30-go-path.sh`: Go toolchain paths.
- `rsc/user/home/user/.config/bash.d/40-android.sh`: Android SDK paths.
- `rsc/user/home/user/.config/bash.d/50-nvm.sh`: NVM (Node Version Manager) paths.
- `rsc/user/home/user/.config/bash.d/60-bun.sh`: Bun paths.
- `rsc/user/home/user/.config/bash.d/70-opencode.sh`: OpenCode paths.
- `rsc/user/home/user/.config/bash.d/80-env.sh`: User environment files (API keys).
- `rsc/user/home/user/.config/bash.d/90-shell.sh`: Common shell defaults (PATH, editor, aliases).
