...
- Core utilities: bash, git, curl, wget, rsync, jq, grep, ripgrep, less, file, find, xargs, sed, awk, bubblewrap, inotifywait, xvfb, tokei, xxd, sudo
...
- AI Tools: claude, gemini, codex, kilo, qwen-code, opencode, amp, pi, agent-browser
- Containers: podman (rootless)
- Virtualization: qemu-kvm, libvirt-clients
- Media: ffmpeg, imagemagick
- Android: android-sdk, gradle, adb, sdkmanager
- Database: sqlite3
- Network: curl, wget, net-tools, iproute2, nmap, tcpdump, dig, host, nslookup, whois, tailscale
- GitHub: gh
