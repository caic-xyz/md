...
- Core utilities: bash, git, curl, wget, rsync, jq, grep, ripgrep, less, man, file, find, xargs, sed, awk, col, bubblewrap, inotifywait, xvfb, tokei, xxd, sudo
...
- Containers: podman (rootless, vfs storage, requires -sudo for nested containers)
